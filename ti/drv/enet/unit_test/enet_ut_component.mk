...
#
# Enet ICSSG Unit Test (TI-RTOS, FreeRTOS)
#
...
# - SafeRTOS example should be added to the example list only if SafeRTOS Kernel is present in the path.
#
define ENET_ICSSG_UNIT_TESTAPP_RULE

export enet_icssg_unit_testapp_$(1)_COMP_LIST = enet_icssg_unit_testapp_$(1)
enet_icssg_unit_testapp_$(1)_RELPATH = ti/drv/enet/unit_test/enet_icssg_ut
enet_icssg_unit_testapp_$(1)_PATH = $(PDK_ENET_COMP_PATH)/unit_test/enet_icssg_ut
export enet_icssg_unit_testapp_$(1)_BOARD_DEPENDENCY = yes
export enet_icssg_unit_testapp_$(1)_CORE_DEPENDENCY = yes
export enet_icssg_unit_testapp_$(1)_XDC_CONFIGURO = $(if $(findstring tirtos,$(1)),yes,no)
export enet_icssg_unit_testapp_$(1)_MAKEFILE = -f makefile BUILD_OS_TYPE=$(1)
enet_icssg_unit_testapp_$(1)_PKG_LIST = enet_icssg_unit_testapp_$(1)
enet_icssg_unit_testapp_$(1)_INCLUDE = $(enet_icssg_unit_testapp_$(1)_PATH)
export enet_icssg_unit_testapp_$(1)_$(SOC)_CORELIST = $(filter $(DEFAULT_$(SOC)_CORELIST_$(1)), mcu1_0)
export enet_icssg_unit_testapp_$(1)_BOARDLIST = $(filter $(DEFAULT_BOARDLIST_$(1)), am65xx_idk am65xx_evm)
export enet_icssg_unit_testapp_$(1)_SOCLIST = $(filter $(DEFAULT_SOCLIST_$(1)), am65xx)
ifeq ($(SOC),$(filter $(SOC), am65xx))
export enet_icssg_unit_testapp_$(1)_SBL_APPIMAGEGEN = yes
endif
ifeq ($(1),$(filter $(1), freertos))
enet_ut_EXAMPLE_LIST += enet_icssg_unit_testapp_$(1)
else
ifneq ($(wildcard $(SAFERTOS_KERNEL_INSTALL_PATH)),)
enet_ut_EXAMPLE_LIST += enet_icssg_unit_testapp_$(1)
endif
...
ENET_ICSSG_UNIT_TESTAPP_MACRO_LIST := $(foreach curos,$(drvenet_RTOS_LIST),$(call ENET_ICSSG_UNIT_TESTAPP_RULE,$(curos)))

$(eval ${ENET_ICSSG_UNIT_TESTAPP_MACRO_LIST})
