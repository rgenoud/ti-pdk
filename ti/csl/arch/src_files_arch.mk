...
ifeq ($(SOC),$(filter $(SOC), tda2xx tda2px dra75x tda2ex dra72x tda3xx am574x am572x am571x dra78x am64x am62x am263x))
...
ifeq ($(SOC),$(filter $(SOC), am65xx am77x j7200 j721e j721s2 tpr12 awr294x am64x am263x am62x))
