...
PACKAGE_SRCS_COMMON = makefile HwiP.h SwiP.h MuxIntcP.h osal.h osal_component.mk SemaphoreP.h TaskP.h MemoryP.h\
...
ifeq ($(SOC),$(filter $(SOC), j721e j721s2 j784s4 am62x am62a j722s))
  SRCDIR      += soc/$(SOC)
