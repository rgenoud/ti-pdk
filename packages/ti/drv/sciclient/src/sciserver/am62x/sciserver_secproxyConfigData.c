...
const struct Sciserver_SecureProxyTxThreadConfig Sciserver_SecureProxyTxConfigurations[SOC_MAX_SPT_TX_CONFIG_INSTANCES] = {
	...
	[AM62X_DMASS0_SEC_PROXY_0_TX_DM_NONSEC_MAIN_0_R5_3_RESPONSE_TX_THR068_CONF005] = {
		.host_id		= HOST_ID_DM,
		.thread_id		= 68U,
		.num_credits		= 2U,
		.threshold		= 1U,
	...
	[AM62X_DMASS0_SEC_PROXY_0_TX_DM_NONSEC_A53_1_RESPONSE_TX_THR067_CONF006] =	 {
		.host_id		= HOST_ID_DM,
		.thread_id		= 67U,
		.num_credits		= 6U,
		.threshold		= 1U,
	...
	[AM62X_DMASS0_SEC_PROXY_0_TX_DM_NONSEC_ICSSG_0_RESPONSE_TX_THR062_CONF011] =	 {
		.host_id		= HOST_ID_DM,
		.thread_id		= 62U,
		.num_credits		= 2U,
		.threshold		= 1U,
	...
	[AM62X_DMASS0_SEC_PROXY_0_TX_ICSSG_0_LOW_PRIORITY_THR021_CONF023] =		 {
...
const struct Sciserver_SecureProxyRxThreadConfig gSciserverSecureProxyRxConfigurations[SOC_MAX_SPT_RX_CONFIG_INSTANCES] = {
	...
	[AM62X_DMASS0_SEC_PROXY_0_RX_ICSSG_0_RESPONSE_THR020_CONF013] =			{
		.host_id			= HOST_ID_ICSSG_0,
		.thread_id			= 20U,
		.threshold			= 1U,
		.evt_threshold			= SOC_SAFE_EVENT,
