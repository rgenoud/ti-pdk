 ...
 *
 * DMSC Tx Routing Data for AM62X device
 *
...
const struct sproxy_host_tx_thread_data sproxy_route_data[AM62X_CONFIG_MAX] = {
	 ...
	 */
	[HOST_ID_MAIN_0_R5_0] = {
		.sproxy_resp_conf_id	= AM62X_DMASS0_SEC_PROXY_0_TX_DMSC_SEC_MAIN_0_R5_0_RESPONSE_TX_THR074_CONF000,
		.sproxy_ntfy_conf_id	= AM62X_DMASS0_SEC_PROXY_0_TX_DMSC_SEC_MAIN_0_R5_0_RESPONSE_TX_THR074_CONF000,
	},
	/*
	 * Secure Host MAIN_0_R5_2[37]
	 */
	[HOST_ID_MAIN_0_R5_2] = {
		.sproxy_resp_conf_id	= AM62X_DMASS0_SEC_PROXY_0_TX_DMSC_SEC_MAIN_0_R5_2_RESPONSE_TX_THR073_CONF001,
		.sproxy_ntfy_conf_id	= AM62X_DMASS0_SEC_PROXY_0_TX_DMSC_SEC_MAIN_0_R5_2_RESPONSE_TX_THR073_CONF001,
	},
	/*
	 * Secure Host A53_0[10]
	 */
	[HOST_ID_A53_0] =	{
		.sproxy_resp_conf_id	= AM62X_DMASS0_SEC_PROXY_0_TX_DMSC_SEC_A53_0_RESPONSE_TX_THR072_CONF002,
