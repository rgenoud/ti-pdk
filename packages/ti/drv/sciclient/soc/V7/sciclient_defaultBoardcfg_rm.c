...
__attribute__(( aligned(128), section(".boardcfg_data") )) =
	...
	.rm_boardcfg = {
		...
		.resasg = {
			...
			.resasg_entries_size = 101 * sizeof(struct tisci_boardcfg_rm_resasg_entry),
		},
	},
	.resasg_entries = {
		{
		...
		{
			.type = TISCI_RESASG_UTYPE(TISCI_DEV_SA3_SS0_PKTDMA_0, TISCI_RESASG_SUBTYPE_PKTDMA_RING_SAUL_TX_1_CHAN),
			.start_resource = 8U,
			.num_resource = 8U,
			.host_id = TISCI_HOST_ID_MAIN_0_R5_1,
		},
		...
		{
			.type = TISCI_RESASG_UTYPE(TISCI_DEV_SA3_SS0_PKTDMA_0, TISCI_RESASG_SUBTYPE_PKTDMA_RING_SAUL_RX_2_CHAN),
			.start_resource = 24U,
			.num_resource = 8U,
			.host_id = TISCI_HOST_ID_MAIN_0_R5_1,
		},
		{
			.type = TISCI_RESASG_UTYPE(TISCI_DEV_SA3_SS0_PKTDMA_0, TISCI_RESASG_SUBTYPE_PKTDMA_RING_SAUL_RX_3_CHAN),
			.start_resource = 24U,
			.num_resource = 8U,
			.host_id = TISCI_HOST_ID_MAIN_0_R5_1,
		},
		...
		{
			.type = TISCI_RESASG_UTYPE(TISCI_DEV_SA3_SS0_PKTDMA_0, TISCI_RESASG_SUBTYPE_PKTDMA_SAUL_TX_1_CHAN),
			.start_resource = 1U,
			.num_resource = 1U,
			.host_id = TISCI_HOST_ID_MAIN_0_R5_1,
		},
		...
		{
			.type = TISCI_RESASG_UTYPE(TISCI_DEV_SA3_SS0_PKTDMA_0, TISCI_RESASG_SUBTYPE_PKTDMA_SAUL_RX_2_CHAN),
			.start_resource = 2U,
			.num_resource = 1U,
			.host_id = TISCI_HOST_ID_MAIN_0_R5_1,
		},
		{
			.type = TISCI_RESASG_UTYPE(TISCI_DEV_SA3_SS0_PKTDMA_0, TISCI_RESASG_SUBTYPE_PKTDMA_FLOW_SAUL_RX_2_CHAN),
			.start_resource = 8U,
			.num_resource = 8U,
			.host_id = TISCI_HOST_ID_MAIN_0_R5_1,
		},
		{
			.type = TISCI_RESASG_UTYPE(TISCI_DEV_SA3_SS0_PKTDMA_0, TISCI_RESASG_SUBTYPE_PKTDMA_SAUL_RX_3_CHAN),
			.start_resource = 3U,
			.num_resource = 1U,
			.host_id = TISCI_HOST_ID_MAIN_0_R5_1,
		},
		{
			.type = TISCI_RESASG_UTYPE(TISCI_DEV_SA3_SS0_PKTDMA_0, TISCI_RESASG_SUBTYPE_PKTDMA_FLOW_SAUL_RX_3_CHAN),
			.start_resource = 8U,
			.num_resource = 8U,
			.host_id = TISCI_HOST_ID_MAIN_0_R5_1,
		},
		...
		{
			.type = TISCI_RESASG_UTYPE(TISCI_DEV_DMASS1_BCDMA_0, TISCI_RESASG_SUBTYPE_RA_ERROR_OES),
			.start_resource = 0U,
			.num_resource = 1U,
			.host_id = TISCI_HOST_ID_MAIN_0_R5_1,
		},
