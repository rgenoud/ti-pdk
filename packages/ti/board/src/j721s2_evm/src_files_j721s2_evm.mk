...
# Temp adding the following to package 'ti/boot' directory, until sbl libs are enabled
# Else there is build error for SBL appimage gen due to missing 'boot' directory
PACKAGE_SRCS_COMMON = ../boot