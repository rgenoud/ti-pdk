/**
* Note: This file was auto-generated by TI PinMux on 10/11/2021 at 5:05:41 PM.
*
...
{
    /* MySYSTEM0 -> MCU_ADC_EXT_TRIGGER0 -> F27 */
    {
...
{
    /* MyWKUP_SYSTEM0 -> WKUP_LF_CLKIN -> J27 */
    {
        PIN_WKUP_GPIO0_67, PIN_MODE(1) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION & ~PIN_INPUT_ENABLE))
    },
    /* MyWKUP_SYSTEM0 -> MCU_RESETSTATz -> A23 */
    {
        PIN_MCU_RESETSTATZ, PIN_MODE(0) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION & ~PIN_INPUT_ENABLE))
    },
    /* MyWKUP_SYSTEM0 -> MCU_RESETz -> A26 */
    {
        PIN_MCU_RESETZ, PIN_MODE(0) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION & ~PIN_INPUT_ENABLE))
    },
    /* MyWKUP_SYSTEM0 -> MCU_SAFETY_ERRORn -> J23 */
    {
        PIN_MCU_SAFETY_ERRORN, PIN_MODE(0) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION & ~PIN_INPUT_ENABLE))
    },
    /* MyWKUP_SYSTEM0 -> PMIC_POWER_EN1 -> G26 */
    {
        PIN_PMIC_POWER_EN1, PIN_MODE(0) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION & ~PIN_INPUT_ENABLE))
    },
    /* MyWKUP_SYSTEM0 -> PORz -> K23 */
    {
        PIN_PORZ, PIN_MODE(0) | \
        ((PIN_PULL_DISABLE) & (~PIN_PULL_DIRECTION & ~PIN_INPUT_ENABLE))
    },
    /* MyWKUP_SYSTEM0 -> RESET_REQz -> A24 */
    {
...
pinmuxBoardCfg_t gJ7AEP_MainPinmuxData[] =
{
    {0, gCpsw2gPinCfg},
    {1, gDebugssPinCfg},
    {2, gGpioPinCfg},
...
pinmuxBoardCfg_t gJ7AEP_WkupPinmuxData[] =
{
    {0, gMcu_adcPinCfg},
    {1, gMcu_cpsw2gPinCfg},
    {2, gMcu_i2cPinCfg},
