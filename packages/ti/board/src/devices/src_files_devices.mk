...
SRCDIR += src/devices/common src/devices/fpd src/devices/sensors
INCDIR += src/devices/common src/devices/fpd src/devices/sensors
SRCS_COMMON += common.c ds90ub953.c ds90ub960.c imx390.c ds90ub9702.c
endif
